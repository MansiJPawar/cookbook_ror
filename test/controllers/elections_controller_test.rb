...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference("Election.count") do
      post elections_url, params: { election: { date_of_birth: @election.date_of_birth, email: @election.email, name: @election.name, password: @election.password, phone_number: @election.phone_number } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { date_of_birth: @election.date_of_birth, email: @election.email, name: @election.name, password: @election.password, phone_number: @election.phone_number } }
